...
PIDDATA g_rgIOIOCustomData[] = {
  ...
  {L"RPM","%3.0f"},
  {L"Throttle Position","%3.0f"},
  {L"Brake Position","%3.0f"},
  {L"Clutch Position","%3.0f"},
  {L"LF Wheelspeed","%3.0f"},
  {L"RF Wheelspeed","%3.0f"},
  {L"LR Wheelspeed","%3.0f"},
  {L"RR Wheelspeed","%3.0f"},
  {L"Exhaust Temperature","%3.0f"},
  {L"LF Tire Temperature","%3.0f"},
  {L"RF Tire Temperature","%3.0f"},
  {L"LR Tire Temperature","%3.0f"},
  {L"RR Tire Temperature","%3.0f"},
  {L"LF Brake Temperature","%3.0f"},
