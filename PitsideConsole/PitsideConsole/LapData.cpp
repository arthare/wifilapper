...
PIDDATA g_rgPIDData[] = 
{
  {L"PIDs supported [01 - 20]",""},
	...
	{L"Dist traveled w/MIL on","%5.1f km"},
	{L"Fuel Rail Press (rel mani vacuum)","%5.1f kPa"},
	{L"Fuel Rail Press (direct inject)","%6.1f kPa"},
	...
	{L"Dist traveled since codes cleared","%5.1f km"},
	{L"Evap Sys Vapor Press","%4.1f Pa"},
	{L"Barometric press","%3.1f kPa"},
